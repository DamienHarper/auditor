...
**Note:** `getDiffs()` method remains as it accepts an optional parameter.
...
Transaction type constants have been replaced by a backed enum:
...
Transaction type constants have been replaced by a native PHP enum.
...
$type = TransactionType::Remove->value;
$type = TransactionType::Associate->value;
$type = TransactionType::Dissociate->value;
```
